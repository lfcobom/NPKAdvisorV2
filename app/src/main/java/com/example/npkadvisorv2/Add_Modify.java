 ...
 * Use the {@link Add_Modify#newInstance} factory method to
...
public class Add_Modify extends Fragment {
    ...
    public static Add_Modify newInstance(String param1, String param2) {
        Add_Modify fragment = new Add_Modify();
